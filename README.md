...
[![CI](https://github.com/Roberdan/convergio-depgraph/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-depgraph/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-depgraph/blob/main/LICENSE)
...
```mermaid
graph LR
    CRATE[convergio-depgraph] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-depgraph = { git = "https://github.com/Roberdan/convergio-depgraph", tag = "v0.1.0" }
```
